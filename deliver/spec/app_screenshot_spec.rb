...
describe Deliver::AppScreenshot do
  ...
  describe "#calculate_display_type" do
    ...
    describe "valid screen sizes" do
      device_tests = {
        ...
        "iPad 13 (M4)" => [
          ["APP_IPAD_13-Portrait{2064x2752}.jpg", DisplayType::APP_IPAD_13],
          ["APP_IPAD_13-Landscape{2752x2064}.jpg", DisplayType::APP_IPAD_13],
          ["iPad 13-Portrait{2064x2752}.jpg", DisplayType::APP_IPAD_13],
          ["iPad_13-Landscape{2752x2064}.jpg", DisplayType::APP_IPAD_13]
        ],
        "11 inch iPad" => [
    ...
    describe "valid iMessage app display types" do
      imessage_tests = {
        ...
        "iPad 13 (M4) iMessage" => [
          ["iMessage/en-GB/APP_IPAD_13-Portrait{2064x2752}.jpg", DisplayType::IMESSAGE_APP_IPAD_13],
          ["iMessage/en-GB/iPad_13-Landscape{2752x2064}.jpg", DisplayType::IMESSAGE_APP_IPAD_13]
        ],
        "11 inch iPad" => [
    ...
    describe "conflict resolution" do
      ...
      it "should resolve iPad Pro 3rd+ gen vs iPad 13 (M4) correctly" do
        expect_display_type_from_file("iPad-Portrait-APP_IPAD_13{2064x2752}.jpg").to eq(DisplayType::APP_IPAD_13)
        expect_display_type_from_file("iPad-Portrait-iPad_13{2064x2752}.jpg").to eq(DisplayType::APP_IPAD_13)
        expect_display_type_from_file("iPad-Portrait-iPad 13{2064x2752}.jpg").to eq(DisplayType::APP_IPAD_13)
        expect_display_type_from_file("iPad-Portrait-generic{2064x2752}.jpg").to eq(DisplayType::APP_IPAD_PRO_3GEN_129)
      end
  ...
  describe "#display_type" do
    ...
    it "should return appropriate display types for iPad 13 displays" do
      expect(app_screenshot_with(Deliver::AppScreenshot::DisplayType::APP_IPAD_13).display_type).to eq(Deliver::AppScreenshot::DisplayType::APP_IPAD_13)
      expect(app_screenshot_with(Deliver::AppScreenshot::DisplayType::IMESSAGE_APP_IPAD_13).display_type).to eq(Deliver::AppScreenshot::DisplayType::IMESSAGE_APP_IPAD_13)
    end

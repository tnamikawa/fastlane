...
module Deliver
  ...
  class AppScreenshot
    ...
    FORMATTED_NAMES = {
      ...
      DisplayType::APP_IPHONE_69 => "iPhone 6.9",
      ...
      DisplayType::APP_IPAD_13 => "iPad 13",
      ...
      DisplayType::IMESSAGE_APP_IPHONE_69 => "iPhone 6.9 (iMessage)",
      ...
      DisplayType::IMESSAGE_APP_IPAD_13 => "iPad 13 (iMessage)",
    ...
    DEVICE_RESOLUTIONS_MESSAGES = {
      ...
      DisplayType::IMESSAGE_APP_IPHONE_69 => DEVICE_RESOLUTIONS[DisplayType::APP_IPHONE_67], # Same as 6.7" for now
      ...
      DisplayType::IMESSAGE_APP_IPAD_13 => DEVICE_RESOLUTIONS[DisplayType::APP_IPAD_13]
    }.freeze
    ...
    CONFLICTING_RESOLUTIONS = [
      ...
      [2048, 2732],
      [2732, 2048],
      # iPad Pro 13" (3rd+ gen) and iPad 13" (M4)
      [2064, 2752],
      [2752, 2064],
    ...
    def self.calculate_display_type(path)
      ...
      # iPad 13" (M4) vs iPad Pro 13" (3rd+ gen)
      when [2064, 2752], [2752, 2064]
        is_ipad_13 = path_lower.include?("app_ipad_13") || path_lower.include?("ipad 13") || path_lower.include?("ipad_13")

        if is_ipad_13
          return is_imessage ? DisplayType::IMESSAGE_APP_IPAD_13 : DisplayType::APP_IPAD_13
        else
          return is_imessage ? DisplayType::IMESSAGE_APP_IPAD_PRO_3GEN_129 : DisplayType::APP_IPAD_PRO_3GEN_129
        end
